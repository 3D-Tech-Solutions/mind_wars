...
class BuildConfig {
  ...
  static String get wsBaseUrl {
    if (isLocal) {
      // [2026-04-06 Bugfix] Use direct multiplayer server port 3001 for local dev
      // Docker multiplayer server listens on 3001, no nginx gateway needed
      // The Socket.io client will connect to http://$_localApiHost:3001
