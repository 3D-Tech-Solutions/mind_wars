...
| C-05b | Profanity bypass detection | SHOULD | Bypass attempts (spacing, l33tspeak, homoglyphs) are flagged for review |
...
| C-10 | GIF and sticker support | SHOULD | Only approved/allowlisted GIFs and stickers render inline; non-approved media is rejected with an error |
