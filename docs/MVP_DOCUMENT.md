...
> **Historical note:** this document reflects the November 2025 MVP/alpha baseline.  
> For the current public-launch acceptance baseline, use [`docs/project/V1_0_RELEASE_REQUIREMENTS.md`](project/V1_0_RELEASE_REQUIREMENTS.md) and [`docs/project/PROJECT_STATUS.md`](project/PROJECT_STATUS.md).  
> Production-readiness and backend-completeness statements here are historical, not the current public-v1.0 release gate.
